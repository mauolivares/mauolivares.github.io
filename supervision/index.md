---
layout: default
title: Working Together on Your Research Project
description: A practical guide to making research supervision focused, collaborative, and useful.
...
At the beginning of the project, we will agree on a realistic timetable. The timetable is a planning tool, not a prediction that everything will proceed perfectly. If a milestone becomes unrealistic, please tell me early so that we can adjust the plan.
...
I will normally provide feedback on a selected section or research output rather than proofread every sentence. You remain responsible for the final version of the thesis and for checking that comments have been addressed appropriately.
...
You can use the following format before each meeting:
